...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 28, 2022 at 02:45 PM
...
--
-- Table structure for table `tabel_coba`
--

CREATE TABLE `tabel_coba` (
  `id` int(11) NOT NULL,
  `umur_id` int(100) NOT NULL,
...
--
-- Dumping data for table `tabel_coba`
--

INSERT INTO `tabel_coba` (`id`, `umur_id`, `menu_id`, `kategori`, `lokasi_id`, `preferensi`) VALUES
(1, 1, 1, 'Makanan Utama', 1, 'Makanan Instan, Makanan Garing, Makanan Lembut'),
(2, 1, 7, 'Makanan Utama', 1, 'Makanan Instan, Makanan Garing'),
(3, 1, 13, 'Makanan Utama', 1, 'Makanan Instan, Makanan Garing, Makanan Lembut');
...
--
-- Indexes for table `tabel_coba`
--
ALTER TABLE `tabel_coba`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT for table `tabel_coba`
--
ALTER TABLE `tabel_coba`
...
--
-- Constraints for table `tabel_coba`
--
ALTER TABLE `tabel_coba`
  ADD CONSTRAINT `tabel_coba_ibfk_1` FOREIGN KEY (`lokasi_id`) REFERENCES `pilihan` (`id`),
  ADD CONSTRAINT `tabel_coba_ibfk_2` FOREIGN KEY (`menu_id`) REFERENCES `menu_mpasi` (`menu_id`),
  ADD CONSTRAINT `tabel_coba_ibfk_3` FOREIGN KEY (`umur_id`) REFERENCES `umur` (`umur_id`);
COMMIT;
