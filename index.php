                    ...
                    <div class="card-body row">
                        <?php
                            if(isset($_GET['umur']) || isset($_GET['lokasi']) || isset($_GET['jenis']))
                            {
                                if(isset($_GET['umur'])){
                                    $umur= $_GET['umur'];
                                    $menu = "SELECT * FROM tabel_coba WHERE umur_id = $umur";   
                                }
                                ...
                                {
                                    while ($menuitems =mysqli_fetch_array($menu_run))
                                    //foreach($menu_run as $menuitems) :
                                           ...
                                           echo' <div class="col-sm-4 col-lg-3 col-md-3">
                                                ...
                                                <p align="center"><strong><a href="#">'. $menuitems['menu_id'] .'</a></strong></p>
